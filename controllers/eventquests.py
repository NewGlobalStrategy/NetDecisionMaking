...
def addndsquests():
    ...
    ndsquests = [{'questiontext': r'Is group decision making a problem?', 'answers': ["Yes", "No"], 'urgency': 4,
                 ...
                 {'questiontext': r'Would an online asynchronous decision making platform be beneficial?',
                  ...
                  'eventid': nds_id},
                 {'qtype': 'action',
                  'questiontext': r'A prototype networked decision making system should be developed', 'numanswers': 2,
                  'answers': ['Approve', 'Disapprove', 'OK'], 'urgency': 8, 'importance': 9,
                  'category': 'Net Decision Making', 'responsible': 'Russ King', 'eventid': nds_id},
                 {'questiontext': r'What is the best method to get feedback on Networked Decision Making?',
                  'numanswers': 3, 'answers': ["You need to draw users to the site and then review actions generated",
                  ...
                  'importance': 7, 'category': 'Net Decision Making', 'eventid': nds_id},
                 {
                     ...
                     'answers': ["Yes", "No"], 'urgency': 4, 'importance': 7, 'category': 'Net Decision Making',
                     'eventid': nds_id},
                 {'questiontext': r'Which social networking platform should be developed first?', 'numanswers': 4,
...
def addevtquests():
    ...
    gsquests = [{'questiontext': r'Is the world under-achieving?', 'answers': ["Yes", "No"], 'urgency': 7,
                    ...
                    'eventid': gs_id},
                {
                    ...
                    'answers': ["Yes", "No"], 'urgency': 7, 'importance': 7, 'category': 'Strategy',
                    'eventid': gs_id},
                {'questiontext': r'What are the best solutions to work on right now?', 'numanswers': 5,
...
def addhealthquests():
    ...
    stdquests = [       
        ...
        {'qtype': 'action',
         ...
         'numanswers': 2, 'answers': ['Approve', 'Disapprove', 'OK'], 'urgency': 8, 'importance': 8,
         'category': 'Healthcare', 'responsible': 'people with >$100M', 'eventid': gs_id},
        {'qtype': 'action',
         ...
         'category': 'Healthcare', 'responsible': 'All global leaders', 'eventid': gs_id},
        {'qtype': 'action',
         ...
         'numanswers': 2, 'answers': ['Approve', 'Disapprove', 'OK'], 'urgency': 8, 'importance': 9, 'category': 'Food',
         'responsible': 'Barrack Obama', 'eventid': gs_id},
        {
