...
class AddBasicQuestion (FunctionalTest):
    ...
    def test_question(self):
        ...
        ans1 = WebDriverWait(self, 10).until(lambda self : self.browser.find_element_by_name('ans1'))
        ans1.send_keys("be")

        #ans2 = self.browser.find_element_by_name('ans2')
        ans2 = WebDriverWait(self, 10).until(lambda self : self.browser.find_element_by_name('ans2'))
